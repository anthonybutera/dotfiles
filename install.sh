...
for package in firefox nmap wget curl zsh zsh-syntax-highlighting nano git fzf tmux neovim python3 python3-pip newsboat mc terminator w3m htop glances rtorrent qbittorent-nox mosh neofetch; 
