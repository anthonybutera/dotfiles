...
for package in aptitude firefox-esr nmap wget curl zsh zsh-syntax-highlighting nano git fzf tmux neovim micro helix python3 python3-pip mc terminator alacritty kitty w3m htop mtr-tiny dnsutils rdesktop freerdp3-x11 eza whois;
