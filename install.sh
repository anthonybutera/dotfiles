...
for package in firefox-esr nmap wget curl zsh zsh-syntax-highlighting nano git fzf tmux neovim python3 python3-pip newsboat mc terminator w3m htop bashtop glances exa mtr-tiny; 
